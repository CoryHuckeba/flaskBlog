...
from flask import render_template, redirect, flash, url_for, session, abort, rew
...
def index(page=1):
    ...
    posts = Post.query.filter_by(live=True).order_by(Post.publish_date.desc()).paginate(
        page, 
        POSTS_PER_PAGE, 
        False
        )
